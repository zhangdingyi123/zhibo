...
var (
	...
	ErrLiveRoomNotEditable    = errors.New("当前直播间不可编辑")
	ErrLiveRoomAlreadyLive    = errors.New("直播间已在直播中")
	ErrLiveRoomNotLive        = errors.New("直播间未开播")
	ErrLiveRoomItemExists     = errors.New("该商品已在直播间货架")
	ErrLiveRoomItemNotFound   = errors.New("货架商品不存在")
	ErrLiveRoomNoItems        = errors.New("请先上架商品再开播")
	ErrCommentEmpty           = errors.New("弹幕内容不能为空")
	ErrCommentTooLong         = errors.New("弹幕内容过长")
